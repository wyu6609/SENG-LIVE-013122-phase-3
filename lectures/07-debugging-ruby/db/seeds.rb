# Note => Run "rake db:seed:replant" to populate DB following successful migrations.
...
p5 = Patient.create({species:'rabbit', name:'ted', age:1, owner:'zac', phone:'999999999', active:true, clinic_id:c2.id})

# Create Vets

v1 = Vet.create({vet_name:'Anderson', speciality:'cats and dogs'})
v2 = Vet.create({vet_name:'Boe', speciality:'cats and dogs'})
v3 = Vet.create({vet_name:'Yasha', speciality:'small pets'})
v4 = Vet.create({vet_name:'Randol', speciality:'small pets'})
